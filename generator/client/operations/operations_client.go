...
type ClientService interface {
	...
	// GetHealthCheckContext health check.
	GetHealthCheckContext(ctx context.Context, params *GetHealthCheckParams, opts ...ClientOption) (*GetHealthCheckOK, error)

	SetTransport(transport runtime.ContextualTransport)
}

// GetHealthCheck healths check.
//
// This method does not support injected context.
// However, timeout and opentracing contexts are honored whenever enabled.
//
// If you need to pass a specific context, use [Client.GetHealthCheckContext] instead.
func (a *Client) GetHealthCheck(params *GetHealthCheckParams, opts ...ClientOption) (*GetHealthCheckOK, error) {
	...
	return a.GetHealthCheckContext(ctx, params, opts...)
}

// GetHealthCheckContext healths check.
//
// Do not use the deprecated [GetHealthCheckParams.Context] with this method: it would be ignored.
func (a *Client) GetHealthCheckContext(ctx context.Context, params *GetHealthCheckParams, opts ...ClientOption) (*GetHealthCheckOK, error) {
