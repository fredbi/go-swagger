...
func NewGetHealthCheckParams() *GetHealthCheckParams {
	return NewGetHealthCheckParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetHealthCheckParams].
