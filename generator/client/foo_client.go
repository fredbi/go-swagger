...
import (
	...
	"github.com/go-swagger/go-swagger/generator/client/operations"
)

// Default foo HTTP client.
var Default = NewHTTPClient(nil)

const (
	// DefaultHost is the default Host found in Meta (info) section of spec file.
	DefaultHost string = "someapi.com"
...
// NewHTTPClient creates a new foo HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Foo {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new foo HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Foo {
...
// New creates a new foo client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Foo {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *Foo) SetTransport(transport runtime.ContextualTransport) {
