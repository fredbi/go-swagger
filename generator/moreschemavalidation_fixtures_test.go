...
func initFixture1479Part() {
	...
	*/
	...
	flattenRun.AddExpectations("container_config.go", []string{
		...
		`		return errors.CompositeValidationError(res...`,
		`var volumesValueEnum []interface{}`,
		`func init() {`,
		`		var res []interface{`,
		"		if err := json.Unmarshal([]byte(`[{}]`), &res); err != nil {",
		`		for _, v := range res {`,
		`			volumesValueEnum = append(volumesValueEnum, v)`,
		`func (m *ContainerConfig) validateVolumesValueEnum(path, location string, value interface{}) error {`,
		`	if err := validate.Enum(path, location, value, volumesValueEnum); err != nil {`,

		`var exposedPortsValueEnum []interface{}`,
		`func init() {`,
		`		var res []interface{`,
		"		if err := json.Unmarshal([]byte(`[{}]`), &res); err != nil {",
		`		for _, v := range res {`,
		`			exposedPortsValueEnum = append(exposedPortsValueEnum, v)`,
		`func (m *ContainerConfig) validateExposedPortsValueEnum(path, location string, value interface{}) error {`,
		`	if err := validate.Enum(path, location, value, exposedPortsValueEnum); err != nil {`,
		...
		`const (`,
		`		RichModeDumbInit = "dumb-init"`,
		`		RichModeSbinInit = "sbin-init"`,
		`		RichModeSystemd = "systemd"`,
		`var richModeEnum = []string{RichModeDumbInit, RichModeSbinInit, RichModeSystemd}`,
		`func (m ContainerConfig) validateRichModeEnum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, richModeEnum); err != nil {`,
	...
	flattenRun.AddExpectations("host_config_all_of0_log_config.go", []string{
		...
		`		TypeEtwlogs = "etwlogs"`,
		`		TypeNone = "none"`,
		`var typeEnum = []string{TypeJSONFile, TypeSyslog, TypeJournald, TypeGelf, TypeFluentd, TypeAwslogs, TypeSplunk, TypeEtwlogs, TypeNone}`,
	...
	flattenRun.AddExpectations("host_config_all_of0.go", []string{
		...
		`var isolationEnum = []string{IsolationDefault, IsolationProcess, IsolationHyperv}`,
		`func (m HostConfigAllOf0) validateIsolationEnum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, isolationEnum); err != nil {`,
	...
	expandRun.AddExpectations("container_create_config.go", []string{
		...
		`		IsolationHyperv = "hyperv"`,
		`var isolationEnum = []string{IsolationDefault, IsolationProcess, IsolationHyperv}`,
		`func (m ContainerCreateConfig) validateIsolationEnum(path, location string, value string) error {`,
		`if err := validate.Enum(path, location, value, isolationEnum); err != nil {`,
...
func initFixtureItching() {
	...
	*/
	...
	flattenRun.AddExpectations("enums_with_additional_props.go", []string{
		...
		`var enumsWithAdditionalPropsEnum []EnumsWithAdditionalProps`,
		`var (`,
		`  	EnumsWithAdditionalPropsA1B2 = make(EnumsWithAdditionalProps, 50)`,
		`   EnumsWithAdditionalPropsA3B4 = make(EnumsWithAdditionalProps, 50)`,
		"	if err := json.Unmarshal([]byte(`\"{ \\\"a\\\": 1, \\\"b\\\": 2 }\"`), (*map[string]interface{})(&EnumsWithAdditionalPropsA1B2)); err != nil {",
		"	if err := json.Unmarshal([]byte(`\"{ \\\"a\\\": 3, \\\"b\\\": 4 }\"`), (*map[string]interface{})(&EnumsWithAdditionalPropsA3B4)); err != nil {",
		`var enumsWithAdditionalPropsEnum []EnumsWithAdditionalProps`,
		`	enumsWithAdditionalPropsEnum = []EnumsWithAdditionalProps{EnumsWithAdditionalPropsA1B2, EnumsWithAdditionalPropsA3B4}`,
		...
		`var (`,
		`		EnumsWithAdditionalPropsValueB2 interface{}`,
		`  	EnumsWithAdditionalPropsValueB4 interface{}`,
		"	if err := json.Unmarshal([]byte(`\"{ \\\"b\\\": 2 }\"`), &EnumsWithAdditionalPropsValueB2); err != nil {",
		"	if err := json.Unmarshal([]byte(`\"{ \\\"b\\\": 4 }\"`), &EnumsWithAdditionalPropsValueB4); err != nil {",
		`var enumsWithAdditionalPropsValueEnum []interface{}`,
		`	enumsWithAdditionalPropsValueEnum = []interface{}{EnumsWithAdditionalPropsValueB2, EnumsWithAdditionalPropsValueB4}`,
...
func initFixtureAdditionalProps() {
	...
	*/
	...
	flattenRun.AddExpectations("additional_things.go", []string{
		...
		`const (`,
		`		AdditionalThingsValueBookshop = "bookshop"`,
		`		AdditionalThingsValueAmazon = "amazon"`,
		`		AdditionalThingsValueLibrary = "library"`,
		`var additionalThingsValueEnum = []string{AdditionalThingsValueBookshop, AdditionalThingsValueAmazon, AdditionalThingsValueLibrary}`,
		...
		`		OriginMuseum = "museum"`,
		`var originEnum = []string{OriginPrint, OriginEBook, OriginCollection, OriginMuseum}`,
		`func (m AdditionalThings) validateOriginEnum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, originEnum); err != nil {`,
		...
		`		StatusOK = "OK"`,
		`		StatusKO = "KO"`,
		`var statusEnum = []string{StatusOK, StatusKO}`,
	...
	flattenRun.AddExpectations("additional_things_nested_additional_properties.go", []string{
		...
		`		PrinterCountryCA = "CA"`,
		`		PrinterCountryDE = "DE"`,
		`var printerCountryEnum = []string{PrinterCountryUS, PrinterCountryFR, PrinterCountryUK, PrinterCountryBE, PrinterCountryCA, PrinterCountryDE}`,
		`func (m AdditionalThingsNestedAdditionalProperties) validatePrinterCountryEnum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, printerCountryEnum); err != nil {`,
	...
	flattenRun.AddExpectations("additional_things_nested.go", []string{
		...
		`		return errors.CompositeValidationError(res...`,
		` const (`,
		`		OriginGoPrint = "goPrint"`,
		`		OriginGoEBook = "goE-book"`,
		`		OriginGoCollection = "goCollection"`,
		`		OriginGoMuseum = "goMuseum"`,
		`var originEnum = []string{OriginGoPrint, OriginGoEBook, OriginGoCollection, OriginGoMuseum}`,
...
func initFixtureTuple() {
	...
	expandRun.AddExpectations("classics.go", []string{
		...
		`		return errors.CompositeValidationError(res...`,
		`const (`,
		`TitleLesMisérables = "Les Misérables"`,
		`TitleBleakHouse = "Bleak House"`,
		`TitleSherlockHolmes = "Sherlock Holmes"`,
		`TitleSiddhartha = "Siddhartha"`,
		`var titleEnum = []string{TitleLesMisérables, TitleBleakHouse, TitleSherlockHolmes, TitleSiddhartha}`,
		`func (m ClassicsClassicsItemsTuple0P0) validateTitleEnum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, titleEnum); err != nil {`,
		...
		`const (`,
		`		ClassicsClassicsItemsTuple0P2ValueBookshop = "bookshop"`,
		`		ClassicsClassicsItemsTuple0P2ValueAmazon = "amazon"`,
		`		ClassicsClassicsItemsTuple0P2ValueLibrary = "library"`,
		`var classicsClassicsItemsTuple0P2ValueEnum = []string{ClassicsClassicsItemsTuple0P2ValueBookshop, ClassicsClassicsItemsTuple0P2ValueAmazon, ClassicsClassicsItemsTuple0P2ValueLibrary}`,
	...
	flattenRun.AddExpectations("classics_items_additional_items_items2.go", []string{
		...
		`const (`,
		`	ClassicsItemsAdditionalItemsItems2ValueBookshop = "bookshop"`,
		`	ClassicsItemsAdditionalItemsItems2ValueAmazon = "amazon"`,
		`	ClassicsItemsAdditionalItemsItems2ValueLibrary = "library"`,
		`var classicsItemsAdditionalItemsItems2ValueEnum = []string{ClassicsItemsAdditionalItemsItems2ValueBookshop, ClassicsItemsAdditionalItemsItems2ValueAmazon, ClassicsItemsAdditionalItemsItems2ValueLibrary}`,
...
func initTodolistSchemavalidation() {
	...
	*/
	...
	flattenRun.AddExpectations("pet.go", []string{
		...
		`		StatusSold = "sold"`,
		`var statusEnum = []string{StatusAvailable, StatusPending, StatusSold}`,
...
func initFixture844Variations() {
	...
	*/
	...
	expandRun.AddExpectations("variation3.go", []string{
		...
		`		return errors.CompositeValidationError(res...`,
		`var (`,
		`Prop1ItemsAbc interface{}`,
		`Prop1ItemsDef interface{}`,
		`func init() {`,
		"if err := json.Unmarshal([]byte(`\"abc\"`), &Prop1ItemsAbc); err != nil {",
		"if err := json.Unmarshal([]byte(`\"def\"`), &Prop1ItemsDef); err != nil {",
		`var prop1ItemsEnum []interface{}`,
		`prop1ItemsEnum = []interface{}{Prop1ItemsAbc, Prop1ItemsDef}`,
...
func initFixtureSimpleTuple() {
	...
	*/
	...
	flattenRun.AddExpectations("tuple_thing_with_map_element.go", []string{
		...
		`	if err := validate.Required("0", "body", m.P0); err != nil {`,
		`	for k := range m.P0 {`,
		`		if err := validate.MaxLength("0"+"."+k, "body", string(m.P0[k]), 10); err != nil {`,
	...
	flattenRun.AddExpectations("tuple_thing_with_not_nullable.go", []string{
		...
		`	if err := validate.RequiredString("0", "body", string(m.P0)); err != nil {`,
		`	if err := validate.MaxLength("0", "body", string(m.P0), 10); err != nil {`,
	...
	flattenRun.AddExpectations("tuple_thing.go", []string{
		...
		`	if err := m.validateP1(formats); err != nil {`,
		`		return errors.CompositeValidationError(res...`,
		`TupleThingTypeP0CONST1 = "CONST1"`,
		`TupleThingTypeP0CONST2 = "CONST2"`,
		`var tupleThingTypeP0Enum = []string{TupleThingTypeP0CONST1, TupleThingTypeP0CONST2}`,
		`func (m TupleThing) validateTupleThingTypeP0Enum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, tupleThingTypeP0Enum); err != nil {`,
		`func (m *TupleThing) validateP0(formats strfmt.Registry) error {`,
		`	if err := validate.Required("0", "body", m.P0); err != nil {`,
		`	if err := m.validateTupleThingTypeP0Enum("0", "body", *m.P0); err != nil {`,
		`TupleThingTypeP1CONST3 = "CONST3"`,
		`TupleThingTypeP1CONST4 = "CONST4"`,
		`var tupleThingTypeP1Enum = []string{TupleThingTypeP1CONST3, TupleThingTypeP1CONST4}`,
		`func (m TupleThing) validateTupleThingTypeP1Enum(path, location string, value string) error {`,
		`	if err := validate.Enum(path, location, value, tupleThingTypeP1Enum); err != nil {`,
		`func (m *TupleThing) validateP1(formats strfmt.Registry) error {`,
		`	if err := validate.Required("1", "body", m.P1); err != nil {`,
		`	if err := m.validateTupleThingTypeP1Enum("1", "body", *m.P1); err != nil {`,
	},
		// not expected
		todo,
		// output in log
	...
	flattenRun.AddExpectations("tuple_thing_with_additional_items.go", []string{
		...
		`	if err := validate.Required("1", "body", m.P1); err != nil {`,
		`	if err := validate.MaximumInt("1", "body", int64(*m.P1), 10, false); err != nil {`,
		`var tupleThingWithAdditionalItemsItemsEnum []int64`,
		`	var res []int64`,
	...
	flattenRun.AddExpectations("tuple_thing_with_array_element.go", []string{
		...
		`	for i := 0; i < len(m.P1); i++ {`,
		`		if err := validate.MinimumInt("1"+"."+strconv.Itoa(i), "body", int64(m.P1[i]), 10, false); err != nil {`,
	...
	flattenRun.AddExpectations("array_of_tuples.go", []string{
		...
		`		if err := validate.MinimumInt("P1"+"."+strconv.Itoa(i), ` +
			`"body", int64(m.P1[i]), 10, false); err != nil {`,
	...
	flattenRun.AddExpectations("tuple_thing_with_object_element.go", []string{
		...
		`	if swag.IsZero(m.Prop1) {`,
		`	if err := validate.MaxLength("prop1", "body", string(m.Prop1), 10); err != nil {`,
	},
		// not expected
		todo,
		// output in log
