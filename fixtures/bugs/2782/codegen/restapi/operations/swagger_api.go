...
func NewSwaggerAPI(spec *loads.Document) *SwaggerAPI {
	return &SwaggerAPI{
		...
		PatchChangeIDHandler: PatchChangeIDHandlerFunc(func(params PatchChangeIDParams) middleware.Responder {
			return middleware.NotImplemented("operation PatchChangeID has not yet been implemented")
		}),
		PostChangeIDHandler: PostChangeIDHandlerFunc(func(params PostChangeIDParams) middleware.Responder {
			return middleware.NotImplemented("operation PostChangeID has not yet been implemented")
		}),
	}
}

/*SwaggerAPI patch with array */
type SwaggerAPI struct {
	...
	// PatchChangeIDHandler sets the operation handler for the patch change ID operation
	PatchChangeIDHandler PatchChangeIDHandler
	// PostChangeIDHandler sets the operation handler for the post change ID operation
	PostChangeIDHandler PostChangeIDHandler
...
func (o *SwaggerAPI) Validate() error {
	...
	if o.PatchChangeIDHandler == nil {
		unregistered = append(unregistered, "PatchChangeIDHandler")
	}
	if o.PostChangeIDHandler == nil {
		unregistered = append(unregistered, "PostChangeIDHandler")
	}
...
func (o *SwaggerAPI) initHandlerCache() {
	...
	o.handlers["PATCH"]["/change/{id}"] = NewPatchChangeID(o.context, o.PatchChangeIDHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/change/{id}"] = NewPostChangeID(o.context, o.PostChangeIDHandler)
}
