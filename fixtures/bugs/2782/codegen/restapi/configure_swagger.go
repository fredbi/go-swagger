...
import (
	...
	"github.com/go-swagger/go-swagger/fixtures/bugs/2782/codegen/restapi/operations"
)

//go:generate swagger generate server --target ../../codegen --name Swagger --spec ../../2782.yaml --principal interface{}
