...
type ClientService interface {
	GetAuth(params *GetAuthParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAuthOK, error)
...
*/
func (a *Client) GetAuth(params *GetAuthParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAuthOK, error) {
