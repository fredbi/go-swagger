...
func NewTimeofdayAPI(spec *loads.Document) *TimeofdayAPI {
	return &TimeofdayAPI{
		...
		PostTimeHandler: PostTimeHandlerFunc(func(params PostTimeParams) middleware.Responder {
			return middleware.NotImplemented("operation PostTime has not yet been implemented")
		}),
	}
}

/*TimeofdayAPI A silly time-of-day */
type TimeofdayAPI struct {
	...
	// PostTimeHandler sets the operation handler for the post time operation
	PostTimeHandler PostTimeHandler
...
func (o *TimeofdayAPI) Validate() error {
	...
	if o.PostTimeHandler == nil {
		unregistered = append(unregistered, "PostTimeHandler")
	}
...
func (o *TimeofdayAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/time"] = NewPostTime(o.context, o.PostTimeHandler)
