...
description: "generate supporting files like the http server and the api builder"
weight: 21
---
...
```cmd
Usage:
  swagger [OPTIONS] generate support [support-OPTIONS] [spec]

generate supporting files like the http server and the api builder
...
{{% include file="generate_support_include.md" %}}
