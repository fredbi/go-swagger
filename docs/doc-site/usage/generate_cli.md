---
title: "generate cli"
description: "generate a command line client tool from the swagger spec"
weight: 7
---
...
[cli command options]
      ...
      -A, --name=                                                                            the name of the application, defaults to a mangled value
                                                                                             of info.title
          --cli-app-name=                                                                    the app name for the cli executable. useful for go
                                                                                             install. (default: cli)
          --cli-package=                                                                     the package to save the cli specific code (default: cli)
...
{{% include file="generate_cli_include.md" %}}
