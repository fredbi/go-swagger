...
```cmd
swagger generate model --model-package data --model Pet ./testdata/petstores/petstore.json
```
...
func (m *Pet) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
