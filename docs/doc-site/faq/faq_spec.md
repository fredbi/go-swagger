...
weight: 50
description: Questions about generating a spec from source
---
...
See [Generating a swagger spec](../generate-spec/spec.md).
...
Is it really all there in [Generate spec](../generate-spec/)?
