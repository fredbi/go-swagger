---
title: Injecting middleware
description: Customizing your server with middleware.
weight: 30
---
## Build Your Own middleware

`go-swagger` relies on `net/http` as its base abstraction.

That means that for _any_ transport supported by the toolkit you can reuse _any_ middleware existing middlewares that following the stdlib middleware pattern.
