...
For all options, see [`generate server`](../../../usage/generate_server.md).
...
For more information about the `swagger serve` command and its options, see the [serve UI documentation](../../../usage/serve.md).
