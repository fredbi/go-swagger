...
weight: 10
description: What you need to install to build a project.
---
...
Before engaging further with `go-swagger`, please take a while to get comfortable with golang basics and conventions.

That will save yourself much time and frustration.
...
The scanner requires a `go` compiler to be installed.
