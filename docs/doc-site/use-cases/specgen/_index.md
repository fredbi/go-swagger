...
* [`genspec`][xyz] a headless CLI 
* [`genspec-tui`][xyz] a TUI to see your spec generated live, with your code side by side
* [`genspec-wasi][xyz] same as the TUI but as a WASI build, no go toolchain - used by our [playground page][playground-url]
